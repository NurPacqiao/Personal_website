    ...
    <section class="home show-animate first-section" id="home">
        <div class="home-content">
            ...
            <p>
                ...
                Together, let's explore the exciting world of creating tailor-made web experiences that stand out from
                the crowd.
    ...
    <section class="about" id="about">
        ...
        <div class="about-content">
            ...
            <p>
                ...
                Proficient in HTML, CSS, and JavaScript, I specialize in transforming ideas into visually stunning
                websites.
                ...
                <div class="education-box">
                    <div class="education-content">
                        <div class="content">
                            ...
                            <p>
                                During my time at Bilim-Innovation Lyceum in Shymkent, I had the opportunity to delve
                                into a diverse range of subjects while fostering a strong foundation in academics.
                                From mathematics to literature, the curriculum provided a comprehensive education that
                                not only challenged me intellectually but also encouraged creativity and critical
                                thinking.
                                Graduating from Bilim-Innovation Lyceum was a milestone in my educational journey,
                                shaping my perspective and preparing me for the exciting opportunities that lay ahead.
                            </p>
                        </div>
                    </div>
                    <div class="education-content">
                        <div class="content">
                            ...
                            <p>
                                During my academic journey, I undertook the renowned CS50 course offered by Harvard
                                University.
                                This immersive program provided a comprehensive introduction to computer science
                                fundamentals,
                                including programming in languages such as C, Python, and JavaScript, as well as topics
                                like algorithms and data structures.
                                Through challenging problem sets and engaging lectures,
                                I gained valuable insights and strengthened my problem-solving skills, setting a solid
                                foundation for my career in frontend development.
                            </p>
                        </div>
                    </div>
                    <div class="education-content">
                        <div class="content">
                            ...
                            <p>
                                ...
                                Since then, I've been actively engaged in coursework and hands-on learning, building a
                                solid foundation in various areas of IT,
                ...
                <div class="education-box">
                    <div class="education-content">
                        <div class="content">
                            ...
                            <p>
                                Over the past year, I've been immersed in the exciting world of frontend development,
                                fueled by my passion for creating engaging user experiences on the web.
                                While I may not have professional experience yet, I've dedicated myself to learning and
                                honing my skills through various avenues.
                            </p>
                        </div>
                    </div>
                    <div class="education-content">
                        <div class="content">
                            ...
                            <ul style="font-size: 1.5rem; list-style-type: none;">
                                <li>Completed the prestigious CS50 course offered by Harvard University, gaining a solid
                                    foundation in computer science fundamentals.</li>
                                <li>Currently pursuing a Bachelor's degree in Computer Science, with a focus on frontend
                                    technologies, at UKEN.</li>
                                <li>Engaged in self-directed learning and hands-on projects to deepen my understanding
                                    of HTML, CSS, JavaScript, and frontend frameworks.</li>
                                <li>Developed several personal projects, experimenting with design and functionality,
                                    and continuously seeking feedback to improve my skills.</li>
                            </ul>
                            </p>
                        </div>
                    </div>
                    <div class="education-content">
                        <div class="content">
                            ...
                            <p>
                                ...
                                I'm enthusiastic about the opportunities ahead and committed to growing as a frontend
                                developer.
                                I'm eager to contribute my creativity, enthusiasm,
                                and growing expertise to collaborative projects and make a positive impact in the world
                                of web development.
                            </p>
                        </div>
                    </div>
